...
{
    OLLCase *ollCase;
    NSArray *ollInfo = @[@[@"oll1.gif",@"(R U2 R') (R' F R F') U2 (R' F R F')",@0,@0],
                               @[@"oll2.gif",@"[F (R U R' U') F' ] [f (R U R' U') f']",@0,@0],
                               @[@"oll3.gif",@"[f (R U R' U') f'] U [F (R U R' U') F' ]",@0,@1],
                               @[@"oll4.gif",@"[f (R U R' U') f'] U' [F (R U R' U') F' ]",@0,@1],
                               @[@"oll5.gif",@"(R U R' U) (R' F R F') U2 (R' F R F')",@0,@3],
                               @[@"oll6.gif",@"[F (R U R' U) F'] y' U2 (R' F R F')",@0,@2],
                               @[@"oll7.gif",@"M U (R U R' U') M' (R' F R F') ",@0,@2],
                               @[@"oll8.gif",@"M U (R U R' U') M2 (U R U' r')",@0,@4],
                               @[@"oll9.gif",@"R' U2 R2 U R' U R U2 x' U' R' U",@1,@0],
                               @[@"oll10.gif",@"F (R U R' U') R F' (r U R' U') r'",@1,@0],
                               @[@"oll11.gif",@"f (R U R' U') (R U R' U') f'",@1,@0],
                               @[@"oll12.gif",@"(R U R' U) R d' R U' R' F'",@1,@0],
                               @[@"oll13.gif",@"(r U R' U) (R U' R' U) R U2' r'",@2,@0],
                               @[@"oll14.gif",@"l' U' L U' L' U L U' L' U2 l",@2,@0],
                               @[@"oll15.gif",@"(R' F R' F') R2 U2 y (R' F R F')",@2,@0],
                               @[@"oll16.gif",@"R' F R2 B' R2' F' R2 B R'",@2,@0],
                               @[@"oll17.gif",@"F (R U R' U') (R U R' U') F'",@2,@0],
                               @[@"oll18.gif",@"F' (L' U' L U) (L' U' L U) F",@2,@0],
                               @[@"oll19.gif",@"(r U R' U) R U2 r'",@2,@1],
                               @[@"oll20.gif",@"r' U' R U' R' U2 r",@2,@1],
                               @[@"oll21.gif",@"[F (R U R' U') F'] U [F (R U R' U') F' ]",@2,@1],
                               @[@"oll22.gif",@"[F' (L' U' L U) F] y [F (R U R' U') F']",@2,@1],
                               @[@"oll23.gif",@"(R U R' U') R' F R2 U R' U' F'",@2,@1],
                               @[@"oll24.gif",@"(R U R' U) (R' F R F') R U2 R'",@2,@1],
                               @[@"oll25.gif",@"r' U2 (R U R' U) r",@2,@1],
                               @[@"oll26.gif",@"r U2 R' U' R U' r'",@2,@1],
                               @[@"oll27.gif",@"F U R U' R2 F' R (U R U' R')",@1,@1],
                               @[@"oll28.gif",@"R' F R U R' F' R y' (R U' R')",@1,@1],
                               @[@"oll29.gif",@"(r U r') (R U R' U') (r U' r')",@1,@1],
                               @[@"oll30.gif",@"(l' U' l) (L' U' L U) (l' U l)",@1,@1],
                               @[@"oll31.gif",@"[(R U R' U) R U2 R'] [F (R U R' U') F']",@2,@2],
                               @[@"oll32.gif",@"(R' F R F') (R' F R F') (R U R' U') (R U R')",@2,@2],
                               @[@"oll33.gif",@"(R2 U R' B' R) U' (R2 U R B R')",@2,@2],
                               @[@"oll34.gif",@"(R U R' U') R U' R' F' U' F (R U R')",@2,@2],
                               @[@"oll35.gif",@"R U B' U' R' U R B R'",@2,@2],
                               @[@"oll36.gif",@"R' U' F U R U' R' F' R",@2,@2],
                               @[@"oll37.gif",@"F R U' R' U' R U R' F'",@2,@3],
                               @[@"oll38.gif",@"f (R U R' U') f'",@2,@2],
                               @[@"oll39.gif",@"f ' (L' U' L U) f",@2,@2],
                               @[@"oll40.gif",@"(R U2 R') (R' F R F') (R U2 R')",@2,@03],
                               @[@"oll41.gif",@"F (R U R' U') F'",@01,@2],
                               @[@"oll42.gif",@"(R U R' U') (R' F R F')",@1,@2],
                               @[@"oll43.gif",@"R B' R' U' R U B U' R' ",@1,@03],
                               @[@"oll44.gif",@"R' [F (R U R' U') F'] U R",@1,@3],
                               @[@"oll45.gif",@"(R U R2 U') (R' F) (R U) (R U') F'",@1,@2],
                               @[@"oll46.gif",@"R' U' (R' F R F') U R",@1,@2],
                               @[@"oll47.gif",@"(R U R' U) (R U' R' U') (R' F R F')",@2,@3],
                               @[@"oll48.gif",@"(L' U' L U') (L' U L U) (L F' L' F)",@2,@3],
                               @[@"oll49.gif",@"algorithm",@3,@0],
                               @[@"oll50.gif",@"algorithm",@3,@0],
                               @[@"oll51.gif",@"algorithm",@3,@2],
                               @[@"oll52.gif",@"algorithm",@3,@2],
                               @[@"oll53.gif",@"algorithm",@3,@3],
                               @[@"oll54.gif",@"algorithm",@3,@1],
                               @[@"oll55.gif",@"algorithm",@3,@1],
                               @[@"oll56.gif",@"M' U M U2 M' U M",@2,@4],
                               @[@"oll57.gif",@"(R U R' U') M' (U R U' r')",@1,@4]];
